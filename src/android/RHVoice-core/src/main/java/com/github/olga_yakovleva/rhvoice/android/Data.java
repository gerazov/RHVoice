...
public final class Data
{
    ...
    static
    {
        ...
        addLanguage(lang);
        lang=new LanguagePack("Polish", "pol", "pl", "POL", "PL", false, 1, 6, Checksums.LANGUAGE_POLISH, "http://zlotowicz.pl/files/RHVoice-language-Polish-v1.6.zip", null);
        lang.addVoice(new VoicePack("Magda", lang, 4, 10, Checksums.VOICE_MAGDA, "http://zlotowicz.pl/files/RHVoice-voice-Polish-Magda-v4.10.zip", null));
        addLanguage(lang);
}
